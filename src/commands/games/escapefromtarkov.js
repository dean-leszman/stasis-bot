...
ammoRegex[".45 ACP"] = /^((\.?45 ?(ACP)?)|(ACP)|M1911(A1)?)$/gi;
...
ammoRegex["9x19mm"] = /^(9x19(mm)?)|MP(5(\-?K)?|7|(9(\-?N)?)|X)|PP(\-| )?19|Saiga((\-| )?9)?$/gi;
